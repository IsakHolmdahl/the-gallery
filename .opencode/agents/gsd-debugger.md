...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/isakholmdahl/Git/art-teacher/.opencode
                  → checks /Users/isakholmdahl/Git/art-teacher/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/isakholmdahl/Git/art-teacher/.opencode/get-shit-done
                  → writes to /Users/isakholmdahl/Git/art-teacher/.opencode/get-shit-done/hooks/
...
@/Users/isakholmdahl/Git/art-teacher/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/isakholmdahl/Git/art-teacher/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/isakholmdahl/Git/art-teacher/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/isakholmdahl/Git/art-teacher/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/isakholmdahl/Git/art-teacher/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
