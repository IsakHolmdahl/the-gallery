...
```bash
INIT=$(node "/Users/isakholmdahl/Git/art-teacher/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${after_phase}")
...
```bash
RESULT=$(node "/Users/isakholmdahl/Git/art-teacher/.opencode/get-shit-done/bin/gsd-tools.cjs" phase insert "${after_phase}" "${description}")
```
