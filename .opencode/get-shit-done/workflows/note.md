...
- **Global scope**: `/Users/isakholmdahl/Git/art-teacher/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/isakholmdahl/Git/art-teacher/.opencode/notes/`)
...
2. Glob `/Users/isakholmdahl/Git/art-teacher/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/isakholmdahl/Git/art-teacher/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/isakholmdahl/Git/art-teacher/.opencode/notes/` — works in any directory
